...
function parseStatsConfig(raw: unknown): AppConfig["stats"] {
  ...
  return {
    ...
    bindings: {
      ...
      spellStatMultiplier: asNumber(bindings.spellStatMultiplier, 0.25),
      spellLevelScalingRate: asNumber(bindings.spellLevelScalingRate, 1.30),
      spellVarianceMin: asNumber(bindings.spellVarianceMin, 0.85),
      spellVarianceMax: asNumber(bindings.spellVarianceMax, 1.15),
      healStat: asString(bindings.healStat, "WIS"),
      healStatMultiplier: asNumber(bindings.healStatMultiplier, 0.25),
      healLevelScalingRate: asNumber(bindings.healLevelScalingRate, 1.30),
      healVarianceMin: asNumber(bindings.healVarianceMin, 0.85),
      healVarianceMax: asNumber(bindings.healVarianceMax, 1.15),
      buffStat: asString(bindings.buffStat, "CHA"),
      buffDurationPerStat: asNumber(bindings.buffDurationPerStat, 0.02),
      buffMagnitudePerStat: asNumber(bindings.buffMagnitudePerStat, 0.02),
