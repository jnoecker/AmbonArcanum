...
const BASE_CONFIG: AppConfig = {
  ...
  globalAssets: {
    ...
    action_attack: "action_attack.png",
    action_quest: "action_quest.png",
    action_talk: "action_talk.png",
    action_shop: "action_shop.png",
    action_cinematic: "action_cinematic.png",
